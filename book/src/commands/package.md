...
Manage packages in activated environments. All commands require an activated environment and use `uv --project` internally, allowing you to manage packages from any directory.
